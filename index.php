<?php require'layouts/header.php'?>
    ...
    <section id="instructor">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="assets/img/brad-elvis.png" class="img-responsive" alt="Image">
                </div>
            </div><!-- row -->
        </div><!-- container -->
    </section><!-- instructor -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="assets/img/ben.png" alt="Ilustration of a man with a moustache">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
                                These videos are well created, concise, fast paced, easy to follow, and just funny
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="assets/img/aj.png" alt="Ilustration of a man with a beard">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
                                These videos are well created, concise, fast paced, easy to follow, and just funny
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="assets/img/ernest.png" alt="Ilustration of a man with a goatee">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
                                These videos are well created, concise, fast paced, easy to follow, and just funny
    ...
    <?php require'layouts/signup.php' ?>
